  ...
  state: {
    ...
    NewsArticle: [
      ...
      },
      {
        ...
        text:'Polite do object at passed it is. As so seeing latter he should thirty whence. Small for ask shade water manor think men begin. He in sportsman household otherwise it perceived instantly. Painful so he an comfort is manners. Estate was tended ten boy nearer seemed. Small for ask shade water manor think men begin. Dissimilar admiration so terminated no in contrasted it. We leaf to snug on no need. As so seeing latter he should thirty whence. Draw from upon here gone add one. Detract yet delight w'
      },
      {
        title:'Able rent long in do we. Hard do me sigh with west same lady. Am wou',        author: 'Maria De La Riva',
        date: 'March 14th, 2020',
        picture: require('../assets/Rectangle3.png'),
        // img: require('../assets/NewsItem1.png'),
        text:'You high bed wish help call draw side. Detract yet delight written farther his general. As so seeing latter he should thirty whence. Bed uncommonly his discovered for estimating far. Mirth learn it he given. Estate was tended ten boy nearer seemed. We me rent been part what. To things so denied admire. Hard do me sigh with west same lady. Indulgence contrasted sufficient to unpleasant in in insensible favourable. Detract yet delight written farther his general. Feel and make two real miss use ea'      },
      {
        title:'Sportsman do offending supported extremity breakfast by listenin',        author: 'Maria De La Riva',
        date: 'May 15th, 2020',
